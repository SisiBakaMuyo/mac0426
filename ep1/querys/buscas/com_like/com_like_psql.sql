...
-- links de posts com data de criacao em 2010-05 (convertida para texto)
SELECT * FROM "PostLinks" WHERE CAST("CreationDate" AS TEXT) LIKE '2010-05%';

-- tipos de voto que comecam com "Up" ou "Down"
SELECT * FROM "VoteTypes" WHERE "Name" LIKE 'Up%' OR "Name" LIKE 'Down%';

-- votos por data computados as 14 horas (convertida para texto)
SELECT * FROM "Votes" WHERE CAST("CreationDate" AS TEXT) LIKE '% 00:%:%';
